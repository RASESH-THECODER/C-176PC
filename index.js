let stories = [
    {
        ...
        "words": ["Mustang", "Porsche", "BMW", "Mercedes", "Audi", "Nano", "KIA", "FORD"]
    },
    {
        "inputs": 7,
        "title": "Sports",
        ...
        "words": ["Badminton", "Cricket", "Baseball", "Boolean", "Football", "Tennis", "BasketBall"]
    },
    {
        "inputs": 12,
        "title": "Country name",
        ...
        "words": ["Europe", "France", "California", "Spain", "Mandarin", "China", "Germany", "Brazil", "Africa", "Amsterdam", "Paris", "Hong Kong"]
    }
]
...
function displayStory(){
    ...
    for (let i =0;i<story.inputs;i++){
        let input_html=`<input type="text" class="input_field" id="input_${i}" placeholder="Input ${i+1}"</button>`
